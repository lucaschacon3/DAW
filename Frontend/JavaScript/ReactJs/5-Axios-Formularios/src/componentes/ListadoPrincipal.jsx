...
const ListadoPrincipal = () => {
  ...
  return (
    <>
        ...
        {aficiones.length > 0 ? (
          aficiones.map((aficion) => (
            <li key={aficion.id} className="aficion-item">
              ...
              <div>
                <button onClick={() => consultarAficion(aficion)}>
                  Consulta
                </button>
      ...
      <button className="add-aficion-btn" onClick={crearAficion}>
        Añadir Afición
      </button>
      ...
      >
        {aficionSeleccionada && (
          <AficionConsultar aficion={aficionSeleccionada} />
        )}
      </Modal>
