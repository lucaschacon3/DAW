...
import servicioUsuario from "../service/ServicioUsuario"; // Importar servicio
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const nuevoUsuario = { nombre: usuario, password: hashedPassword };
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input 
              ...
              required 
              className="text-white w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
            />
          </div>
